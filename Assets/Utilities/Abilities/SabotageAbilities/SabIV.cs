...
public class SabIV : Ability
{
    ...
    public override AbilityIndex AbilityIndex => AbilityIndex.SABOTAGE4;
    ...
    public override void ApplyPrimaryEffect(Squadron squadron)
    {
        ...
        {
            squadron.SabPowers.SabotagePower.DecreaseEnemyAttack = EffectValue + ComboEffectValue;
            EffectApplied=true;            
        }
    }
    ...
    protected override string GetName() => GameManager.Instance.PlayerPreferences.Lang.NameSabIV;
    protected override string GetDescription() => GameManager.Instance.PlayerPreferences.Lang.DescriptionSabIV(ChanceValue, EffectValue, ComboEffectValue);
}
