...
public class SabX : Ability
{
    ...
    public override AbilityIndex AbilityIndex => AbilityIndex.SABOTAGE10;
    ...
    public override void ApplyPrimaryEffect(Squadron squadron)
    {
        ...
        {
            squadron.SabPowers.HealthPower.BonusHp = 
    ...
    protected override string GetName() => GameManager.Instance.PlayerPreferences.Lang.NameSabX;
    protected override string GetDescription() => GameManager.Instance.PlayerPreferences.Lang.DescriptionSabX(ChanceValue, EffectValue, ComboEffectValue);
}
