...
public class DfVIII : Ability
{
    ...
    public override AbilityIndex AbilityIndex => AbilityIndex.DEFENSE8;
    ...
    protected override string GetName() => GameManager.Instance.PlayerPreferences.Lang.NameDfVIII;
    protected override string GetDescription() => GameManager.Instance.PlayerPreferences.Lang.DescriptionDfVIII(ChanceValue, EffectValue, ComboEffectValue);
}
